...
export const metadata: Metadata = {
  title: 'Steam Gift Cards - CDKeyDeals',
  description: 'Buy Steam Wallet gift cards at best prices. Instant delivery, secure payment.',
};

export default function SteamGiftCardsPage() {
  const steamProducts = giftCardData.filter(product => product.platform === 'Steam');
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-lg">
                Top up your Steam wallet with instant delivery
              </p>
            </div>
          </div>
        </div>
