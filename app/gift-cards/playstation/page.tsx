...
export const metadata: Metadata = {
  title: 'PlayStation Gift Cards - CDKeyDeals',
  description: 'Buy PlayStation Store gift cards at best prices. Instant delivery, secure payment.',
};

export default function PlayStationGiftCardsPage() {
  const playstationProducts = giftCardData.filter(product => product.platform === 'PlayStation');
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-100 text-lg">
                Top up your PlayStation wallet with instant delivery
              </p>
            </div>
          </div>
        </div>
