    ...
    <>
      ...
      <SectionContainer background="white" padding="sm">
        <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-muted-foreground">
          ...
          <span className="text-gray-900 dark:text-foreground font-medium">Terms & Conditions</span>
        </nav>
      </SectionContainer>
      ...
      <SectionContainer background="white" maxWidth="2xl">
        <div className="prose prose-lg max-w-none">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-4">Agreement to Terms</h2>
      ...
      <SectionContainer background="light">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">Description of Service</h2>
        ...
        <div className="bg-white dark:bg-card p-6 rounded-lg shadow-sm border border-gray-100 dark:border-border">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-foreground">Digital Game Keys</h4>
                <p className="text-sm text-gray-600 dark:text-muted-foreground">Steam, PlayStation, Xbox, Nintendo, and other gaming platform keys</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-foreground">Software Licenses</h4>
                <p className="text-sm text-gray-600 dark:text-muted-foreground">Windows, Office, and professional software licenses</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-foreground">Gift Cards</h4>
                <p className="text-sm text-gray-600 dark:text-muted-foreground">Digital gift cards for various platforms and services</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-foreground">Instant Delivery</h4>
                <p className="text-sm text-gray-600 dark:text-muted-foreground">Immediate digital delivery upon purchase completion</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <SectionContainer background="white">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">User Accounts</h2>
        
        <div className="space-y-6">
          <div className="bg-gray-50 dark:bg-muted p-6 rounded-lg border border-gray-200 dark:border-border">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-4">Account Registration</h3>
          ...
          <div className="bg-gray-50 dark:bg-muted p-6 rounded-lg border border-gray-200 dark:border-border">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-4">Account Termination</h3>
            <p className="text-gray-700 dark:text-muted-foreground leading-relaxed mb-3">
      ...
      <SectionContainer background="light">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">Purchases and Payments</h2>
        
        <div className="bg-white dark:bg-card p-6 rounded-lg shadow-sm border border-gray-100 dark:border-border">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-4">Payment Terms</h3>
          <ul className="space-y-2 text-gray-700 dark:text-muted-foreground mb-6">
            <li className="flex items-start">
              <span className="text-[#00d4aa] mr-2 mt-1">•</span>
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-4">Digital Delivery</h3>
          <ul className="space-y-2 text-gray-700 dark:text-muted-foreground">
            <li className="flex items-start">
              <span className="text-[#00d4aa] mr-2 mt-1">•</span>
      ...
      <SectionContainer background="white">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">Intellectual Property</h2>
        
        <div className="space-y-6">
          <div className="bg-gray-50 dark:bg-muted p-6 rounded-lg border border-gray-200 dark:border-border">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-4">Our Content</h3>
            <p className="text-gray-700 dark:text-muted-foreground leading-relaxed">
          ...
          <div className="bg-gray-50 dark:bg-muted p-6 rounded-lg border border-gray-200 dark:border-border">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-4">Third-Party Content</h3>
            <p className="text-gray-700 dark:text-muted-foreground leading-relaxed">
      ...
      <SectionContainer background="light">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">Prohibited Activities</h2>
        ...
        <div className="bg-white dark:bg-card p-6 rounded-lg shadow-sm border border-gray-100 dark:border-border">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
              ...
              <ul className="space-y-1 text-sm text-gray-700 dark:text-muted-foreground">
      ...
      {/* Refund Policy */}
      <SectionContainer background="white">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">Refund Policy</h2>
        
        <div className="bg-gray-50 dark:bg-muted p-6 rounded-lg border border-gray-200 dark:border-border">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-4">Digital Products</h3>
          <p className="text-gray-700 dark:text-muted-foreground leading-relaxed mb-4">
            Due to the nature of digital products, we generally do not offer refunds except in the following circumstances:
          </p>
          
          <ul className="space-y-2 text-gray-700 dark:text-muted-foreground mb-4">
            <li className="flex items-start">
      ...
      <SectionContainer background="light">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">Limitation of Liability</h2>
      ...
      {/* Governing Law */}
      <SectionContainer background="white">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">Governing Law</h2>
      ...
      {/* Changes to Terms */}
      <SectionContainer background="light">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">Changes to Terms</h2>
        ...
        <p className="text-gray-700 dark:text-muted-foreground leading-relaxed mt-4">
      ...
      {/* Contact Information */}
      <SectionContainer background="white">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-6">Contact Information</h2>
