    ...
    <section className="max-w-[1200px] mx-auto px-4 py-10 font-sans">
      ...
      <div className="bg-[#8E61FF] rounded-2xl p-6 md:p-10 flex flex-col md:flex-row items-center relative overflow-hidden">
        ...
        <div className="w-full md:w-2/3 flex gap-4 mt-10 md:mt-0 justify-center items-center relative">
            {/* Arrow Left */}
            <button className="absolute left-0 z-20 bg-white rounded-full p-2 shadow-xl text-gray-400">
                <ChevronLeft size={20} />
            </button>
            ...
            <div className="grid grid-cols-3 gap-4">
                {[1, 2, 3].map((i) => (
                    <div key={i} className="bg-white p-3 rounded-xl shadow-2xl transform scale-105">
                         <div className="aspect-square relative mb-2">
                             <Image src={`/p${i}.png`} alt="promo" fill className="object-contain" />
                         </div>
                         <div className="text-[10px] font-bold text-gray-800 truncate">Office 2024 Pro Plus License</div>
                         <div className="text-xs font-black text-blue-600">Tk 1,700.00 BDT</div>
                    </div>
                ))}
            </div>

            {/* Arrow Right */}
            <button className="absolute right-0 z-20 bg-white rounded-full p-2 shadow-xl text-gray-400">
