          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex gap-3 max-w-md mx-auto">
              <input
                ...
                required
                className="flex-1 bg-white border border-gray-200 rounded-lg px-4 py-3 text-[#1a1a1a] placeholder-gray-400 focus:outline-none focus:border-[#00d4aa] focus:ring-1 focus:ring-[#00d4aa] transition-colors"
              />
              <button
                type="submit"
