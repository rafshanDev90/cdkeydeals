...
// Platform data for Column 1
const platforms = [
  { name: "Steam", icon: "🎮", description: "PC Gaming Platform" },
  { name: "Epic Games", icon: "🎯", description: "Epic Store Deals" },
  { name: "PlayStation Network", icon: "🎮", description: "PS4 & PS5 Games" },
  { name: "Xbox Game Pass", icon: "🎲", description: "Xbox Gaming" },
...
// Categories for Column 2
const bestDealCategories = [
  { name: "Under $10", icon: Tag, count: "245 items" },
  { name: "Under $25", icon: Tag, count: "189 items" },
  { name: "Flash Discounts", icon: Star, count: "67 items" },
...
// New arrivals for Column 3
const newArrivals = [
  { name: "This Week's Releases", badge: "NEW", count: 12 },
  { name: "Pre-order Specials", badge: "HOT", count: 8 },
    ...
    <MegaMenuWrapper isOpen={isOpen} onClose={onClose}>
      <div className="bg-white">
        <div className="flex h-[480px]">
          ...
          <div className="flex-1 bg-gray-50/50 p-6 border-r border-gray-100">
            <div className="mb-6">
            ...
            <div className="space-y-2">
              {platforms.map((platform, index) => (
                <a
                  key={platform.name}
                  href="#"
                  className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white hover:shadow-sm transition-all duration-200 group"
                  onClick={onClose}
                >
          ...
          <div className="w-80 p-6 bg-gradient-to-br from-gray-50 to-white">
            <div className="mb-6">
              <h3 className="text-lg font-bold text-gray-900 mb-2">Featured Deals</h3>
