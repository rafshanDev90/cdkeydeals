  ...
  const services: ServiceCard[] = [
    {
      ...
      description:
        "Not satisfied with your key? Our support team will help you quickly with refunds or replacements for any activation issues.",
    },
    {
      icon: <Package className="w-8 h-8 text-blue-600" />,
      title: "Check Your Order Status",
      description:
        "Stay updated every step of the way — track your purchase, view your activation key, and access your downloads instantly.",
    },
    {
      icon: <HeadphonesIcon className="w-8 h-8 text-blue-600" />,
      title: "24/7 Support Center",
      description:
        "Need help activating Windows or a game key? Browse our guides or contact support anytime. We're here 24/7.",
    },
    {
      icon: <Tag className="w-8 h-8 text-blue-600" />,
      title: "Exclusive Discounts Daily",
      description:
        "Save big on Windows licenses, Office suites, Steam games, Xbox codes, and more — new deals added every day.",
    },
  ];
